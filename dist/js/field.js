...
Nova.booting(function (Vue, router, store) {
    ...
    Vue.component('detail-hasmany-to-modal', __webpack_require__(6));
    Vue.component('form-hasmany-to-modal', __webpack_require__(9));
});
  ...
  return _c(
    ...
    [
      _c(
        ...
        [_vm._v(_vm._s(_vm.field.value.totalRelationship) + " Comments")]
      ),
      _vm._v(" "),
      _vm.showModal
        ? _c("modal", {
