...
Nova.booting(function (Vue, router, store) {
    ...
    Vue.component('index-hasmany-to-modal', __webpack_require__(5));
    /*    Vue.component('detail-hasmany-to-modal', require('./components/DetailField'))
        Vue.component('form-hasmany-to-modal', require('./components/FormField'))*/
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Create__ = __webpack_require__(7);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: { Index: __WEBPACK_IMPORTED_MODULE_1__Index___default.a, Create: __WEBPACK_IMPORTED_MODULE_0__Create___default.a },
    data: function data() {
        return {
            'showModal': false,
    ...
    methods: {
        ...
        setCount: function setCount() {
            ...
            Nova.request().get('/nova-api/' + this.resourceName + '/count', {
                ...
                _this.field.value.totalRelationship = response.data.count;
            });
        },
        changeCreateBtn: function changeCreateBtn() {
            this.showModal = true;
        },
        actionExecuted: function actionExecuted() {
            this.$emit('actionExecuted');
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c(
        "button",
        { class: _vm.addClass, on: { click: _vm.changeCreateBtn } },
        [
          _vm._v(
            _vm._s(_vm.field.value.totalRelationship) +
              " " +
              _vm._s(_vm.field.value.title) +
              "\n    "
          )
        ]
      ),
              ...
              [
                {
                  ...
                  fn: function(props) {
                    return _c(
                      ...
                      {
                        staticClass:
                          "bg-white rounded-lg shadow-lg overflow-hidden col-lg-12",
                                    ...
                                    _vm.showCreateForm
                                      ? _c("create", {
                                          attrs: {
                                            ...
                                            "via-resource-id":
                                              _vm.field.value.resourceId,
                                            "via-relationship":
                                              _vm.field.hasManyRelationship,
                                            "relationship-type": "hasMany"
                                          },
                                          on: { close: _vm.onCreated }
                                        })
                                      : _vm._e()
                                  ],
                                  1
